...
class Person(
    ...
    companion object {
        ...
        fun fromEntity(person: com.singlelab.gpf.database.entity.Person?): Person? {
    ...
    fun toEntity(): com.singlelab.gpf.database.entity.Person {
        return com.singlelab.gpf.database.entity.Person(
            personUid,
            name,
            login,
            description ?: "",
