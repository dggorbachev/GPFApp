...
class EventSummary(
    ...
    companion object {
        ...
        fun fromEntity(eventSummaryEntity: com.singlelab.gpf.database.entity.EventSummary?): EventSummary? {
    ...
    fun toEntity(): com.singlelab.gpf.database.entity.EventSummary {
        return com.singlelab.gpf.database.entity.EventSummary(
            eventUid,
            name,
            description,
            startTime,
