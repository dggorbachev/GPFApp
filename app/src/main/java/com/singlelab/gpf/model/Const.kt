package com.singlelab.gpf.model

import java.util.*

object Const {
    const val URL_KEY = "Url"
    const val APP_NAME = "GPF"
    const val FOLDER_NAME = "GPF Images"
    const val BASE_URL = "https://gpfprod.azurewebsites.net/api/"
    const val STORE_URL = "https://play.google.com/store/apps/details?id=com.company.gpf"
    const val GOOGLE_PLAY = "play.google"

    const val PREF = "gpf_pref"
    const val LOG_TAG = "gpf_app"
