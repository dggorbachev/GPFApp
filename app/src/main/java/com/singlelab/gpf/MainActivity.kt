...
import com.singlelab.gpf.model.target.Target
import com.singlelab.gpf.model.target.TargetType
import com.singlelab.gpf.util.parseDeepLink
    ...
    private fun getPushToken() {
        FirebaseInstanceId.getInstance().instanceId
            .addOnCompleteListener(OnCompleteListener { task ->
                ...
                GPFApplication.preferences?.setPushToken(token)
            })
    }
