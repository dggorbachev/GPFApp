...
class PieceL : Piece {
    ...
    override fun checkRight(pieceList: ArrayList<Piece>) : Boolean {
        ...
        if (rotation == 0){
            ...
            // detect block
            if (pieceList[this.axe + 1].block == "" && pieceList[this.cube4 + 1].block == "" && pieceList[this.cube5 + 1].block == "")
            {
                return true
            }
            ...
            // detect block
            if (pieceList[this.cube2 + 1].block == "" && pieceList[this.cube7 + 1].block == "")
            {
                return true
            }
            ...
            // detect block
            if (pieceList[this.cube4 + 1].block == "" && pieceList[this.cube8 + 1].block == "")
            {
                return true
            }
        }
    ...
    override fun checkLeft(pieceList: ArrayList<Piece>) : Boolean {
        ...
        if (rotation == 0){
            ...
            // detect block
            if (pieceList[this.cube1 - 1].block == "" && pieceList[this.cube7 - 1].block == "")
            {
                return true
            }
    ...
    override fun checkDown(pieceList: ArrayList<Piece>) : Boolean {
        ...
        if (rotation == 0){
            ...
            if (pieceList[this.axe + 10].block == "" && pieceList[this.cube2 + 10].block == "" && pieceList[this.cube3 + 10].block == "")
            {
                return true
            }
            ...
            if (pieceList[this.cube5 + 10].block == "" && pieceList[this.cube6 + 10].block == "")
            {
                return true
            }
            ...
            if (pieceList[this.cube5 + 10].block == "" && pieceList[this.cube8 + 10].block == "")
            {
                return true
            }
        }
    ...
    override fun moveRight(pieceList: ArrayList<Piece>){
        ...
        this.axe += 1
        pieceList[this.axe] = PieceL(this.axe)
